...
import static com.jishiqi.mianshigua.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "jishiqi";
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isEmpty(vipNumber), "vipNumber", vipNumber);
